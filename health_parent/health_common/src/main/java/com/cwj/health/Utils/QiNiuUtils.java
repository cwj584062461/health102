...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "Zl_Wmgje6L-rIuCVjEELk0wlcuKXGDTjWysLl1Bj";
    private static final String SECRETKEY = "SOeOZkT0HQP7FSIn-fGuY7ZUb1kohjkXBskJ7TSC";
    private static final String BUCKET = "szhealth102";
    public static final String DOMAIN= "http://qisqp11br.hn-bkt.clouddn.com/";
